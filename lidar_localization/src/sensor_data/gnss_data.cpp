...
double lidar_localization::GNSSData::origin_heading = 0.0;
...
void GNSSData::UpdateXYZ() {
  ...
  local_heading = heading - origin_heading;
}

Eigen::Matrix3f GNSSData::GetRotationMatrix() {
  Eigen::Matrix3f R = Eigen::Matrix3f::Identity();
  Eigen::Vector3f ea((local_heading) / 180 * M_PI, 0.0, 0.0);  //0 1 2 对应 z y x
